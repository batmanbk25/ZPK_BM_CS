*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_BM_CSTR_DEV
*   generation date: 08.10.2022 at 09:30:44
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_BM_CSTR_DEV     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_BM_CSTR_DEV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_BM_CSTR_DEV_EXTRACT
TOTAL = ZVI_BM_CSTR_DEV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_CSTR_DEV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_BM_CSTR_DEV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_CSTR_DEV_EXTRACT
TOTAL = ZVI_BM_CSTR_DEV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_BM_CSTR_DEV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_BM_CSTR_DEV'
...
TOTAL = ZVI_BM_CSTR_DEV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_BM_CSTR_DEV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_BM_CSTR_DEV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_CSTR_DEV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_BM_CSTR_DEV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_CSTR_DEV_EXTRACT
TOTAL = ZVI_BM_CSTR_DEV_TOTAL
